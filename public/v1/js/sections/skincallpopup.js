    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var Skintools = {
        tpl: '<div class="site-skintools">' +
          ...
          '<i class="icon wb-emoticon primary-600"></i>' +
          '</div>' +
          '<div class="site-skintools-content">' +
          '<div class="nav-tabs-horizontal">' +
          '<ul role="tablist" data-plugin="nav-tabs" class="nav nav-tabs nav-tabs-line">' +
          '<li role="presentation" class="active"><a role="tab" aria-controls="skintoolsSidebar" href="#skintoolsSidebar" data-toggle="tab" aria-expanded="true">Thông tin cuộc gọi</a></li>' +
          ...
          '<div role="tabpanel" id="skintoolsSidebar" class="tab-pane active"><input class="form-control" />dádsds</div>' +
